...
This process defines the design of Edward. Four objects organize the
analysis.
...
model is a class with the structure
\begin{lstlisting}[language=Python]
class Model:
    def __init__(...):
        ...
...
Edward provides criticism using
\begin{itemize}
...
See the \href{api/index.html}{API} for details of how Edward designs these objects.
