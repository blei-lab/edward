...
As a library for \emph{probabilistic modeling} (not necessarily
Bayesian modeling), Edward is for all intents and purposes agnostic to
the paradigm for inference.
This means Edward can be applied with frequentist (population-based)
inferences, strict point estimation, and alternative foundations for
...
in other fields such as deep learning to be complementary: all is in service for
rich probabilistic generative modeling, thus it makes sense to combine
efforts.
