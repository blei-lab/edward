...
points, where each data point regresses with a constant slope among
each other. In our setting, the observations come from sets of
...
latent variables (``random effects''), and $\sigma^2$ is variance
component parameter.
