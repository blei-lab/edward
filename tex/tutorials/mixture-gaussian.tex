...
\begin{align*}
  ...
  &=
  \sum_{k=1}^K \pi_k \, \mathcal{N}(\mathbf{x}_n \mid \mu_k, \sigma_k).
\end{align*}
...
\begin{align*}
  p(\mathbf{\mu}_k)
  &=
  \mathcal{N}(\mathbf{\mu}_k \mid 0, \sigma^2\mathbf{I}).
\end{align*}
...
\begin{align*}
  p(\mathbf{\sigma}_k)
  &=
  \text{InvGamma}(\mathbf{\sigma}_k \mid a, b).
\end{align*}
...
\begin{align*}
  \sum_{n=1}^N \log p(\mathbf{x}_n \mid \pi, \mu, \sigma)
  &=
  \sum_{n=1}^N \log \sum_{k=1}^K \pi_k \, \mathcal{N}(\mathbf{x}_n \mid
  \mu_k, \sigma_k).
\end{align*}
...
\begin{align*}
  ...
  \log \pi_k + \log \mathcal{N}(\mathbf{x}_n \mid \mu_k, \sigma_k)\Big).
\end{align*}
