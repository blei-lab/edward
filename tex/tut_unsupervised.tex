...
Use a simulated (pre-generated) dataset of 2-dimensional datapoints
...
%per-cluster assignment $k$ and per data-point $\mathbf{x}_n$. Then
%take the $\arg\max$ along the rows.
