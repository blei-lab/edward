...
from .util import cumprod, dot, get_dims, get_session, hessian, kl_multivariate_normal, log_sum_exp, logit, multivariate_rbf, rbf, set_seed, softplus, stop_gradient, to_simplex
